                    ...
                    <div className="register-form-1 container col-md-4">
                        <div className="">
                            ...
                            <form>
                                ...
                                <div className="form-group">
                                    <input type="submit" className="btnSubmit btn-dark" disabled={!(registerObject.email && registerObject.password && registerObject.name && registerObject.confirmPassword)}
